...
ADD PRIMARY KEY (`id`),
ADD INDEX `idx__countries_title_ru` (`title` ASC) VISIBLE;
;
...
CHANGE COLUMN `title_ru` `title` VARCHAR(150) NOT NULL ,
ADD PRIMARY KEY (`id`),
ADD INDEX `idx__regions_title` (`title` ASC) VISIBLE,
...
CHANGE COLUMN `region_id` `region_id` INT ,
CHANGE COLUMN `title_ru` `title` VARCHAR(150) NOT NULL ,
ADD PRIMARY KEY (`id`),
ADD INDEX `idx__cities_title` (`title` ASC) VISIBLE,
